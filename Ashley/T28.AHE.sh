...
for i in {1..1121}; do cp ../Homologs/T28_L$i.fasta ../HomologsMultipleRefs/T28_L$i.fasta && for j in {42,43,49,51,52,54,55,64,76,79,86,87,88,91}; do echo -e ">I209${j}_REFERENCE_Copy1" >> ../HomologsMultipleRefs/T28_L$i.fasta && cat ../References/I209${j}.seqs | head -n $i | tail -n 1 >> ../HomologsMultipleRefs/T28_L$i.fasta; done; done
