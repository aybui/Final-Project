...
public class TrimAndMaskRawAlignments3{
  ...
  public static void main(String[] args){
      try{
		...
		int maxNTaxa = Integer.parseInt(args[2]);
		int windowSize = Integer.parseInt(args[3]);
		int minGoodSites = Integer.parseInt(args[4]);
		double propToBeGood = Double.parseDouble(args[5]); //0.5
		int nTaxaMissingAllowed = Integer.parseInt(args[6]);	//1
		String removeFile = args[7];	//e.g. P0001_LociAndTaxaToRemove.txt    ...this file contains information on which loci x taxon combinations to remove, based on geneious visual inspection or other inspection
		String folderTail = "";
